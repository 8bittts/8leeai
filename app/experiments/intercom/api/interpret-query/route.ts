/**
 * API endpoint for interpreting Intercom queries
 * POST /api/intercom/interpret-query
 *
...
import { z } from "zod"
import {
  interpretComplexQuery,
  testConnection,
} from "@/app/experiments/intercom/lib/intercom-openai-client"
import { interpretQuery } from "@/app/experiments/intercom/lib/intercom-query-interpreter"
