import type { APICall, ParsedQuery, QueryIntent } from "./intercom-types"

/**
 * Query Interpreter
 * Converts natural language queries into Intercom API calls.
...
/**
 * Builds Intercom API call from parsed query
 */
...
/**
 * Builds Intercom Query Language (ZQL) string from filters
 */
