...
- **Framework**: [Next.js 16.0.3](https://nextjs.org) with App Router & Turbopack
...
- **AI/ML**: [Vercel AI SDK 5.0.101](https://sdk.vercel.ai), [OpenAI SDK 2.0.71](https://github.com/openai/openai-node)
