...
Launch an 8-member agent team for comprehensive YEN project review. Read `docs/99-team-temp.md` for the team specification.

**Before starting:** Reset `docs/99-team-review.md` by deleting it and copying `docs/99-team-temp.md` to `docs/99-team-review.md`. This ensures a clean slate.
...
Launch an 8-member macOS engineering team for deep native stack review. Read `docs/99-mac.md` for the team specification.

**Before starting:** Reset `docs/99-mac-review.md` by deleting it and copying `docs/99-mac.md` to `docs/99-mac-review.md`. This ensures a clean slate.
...
[NOTE] Full teammate prompts are in ~/.claude/commands/team-mac.md. Each teammate writes findings to docs/99-mac-review.md under their designated section. The devil's advocate waits for other findings before challenging them. Team lead synthesizes into prioritized Action Items at the bottom.
```
...
- Skins design doc: `docs/10-skins.md`
...
2. **Install core tools**
   ...
   brew install deno go pyenv uv ffmpeg zig tokei hyperfine glow tlrc gping
   ```
